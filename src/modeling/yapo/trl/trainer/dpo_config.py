...
class DPOConfig(TrainingArguments):
    ...
    # When True, do not instantiate a separate reference model and instead
    # compute reference log-probs from the same model with steering disabled.
    # This enables a true single-model BiPO setup without precompute.
    single_model_ref: bool = False
